            ...
            <v-card title="FAÇA LOGIN">
                <v-container>
                    ...
                    <v-form v-on:submit.prevent="login">
                        ...
                        <v-text-field id="input-name" v-model="loginForm.email" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira seu nome de usuário"></v-text-field>

                        <label class="mr-sm-2" for="input-password">Senha:</label>
                        <v-text-field id="input-password" v-model="loginForm.password" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira sua senha" type="password"></v-text-field>
            ...
            <v-card title="CRIAR NOVO PERFIL">
                <v-container>
                    ...
                    <v-form v-on:submit.prevent="createUser(novoPerfil)">
                        ...
                        <v-text-field id="input-nome" v-model="novoPerfil.name" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira o nome do novo perfil"></v-text-field>

                        <label class="mr-sm-2" for="input-email">Email:</label>
                        <v-text-field id="input-email" v-model="novoPerfil.email" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira o email do novo perfil"></v-text-field>

                        <label class="mr-sm-2" for="input-password">Senha:</label>
                        <v-text-field id="input-password" v-model="novoPerfil.password" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira a senha do novo perfil" type="password"></v-text-field>

                        <label class="mr-sm-2" for="input-nascimento">Data de Nascimento:</label>
                        <v-text-field id="input-nascimento" v-model="novoPerfil.birthdate" class="mb-2 mr-sm-2 mb-sm-0"
                            placeholder="Insira a data de nascimento do novo perfil"></v-text-field>
